...
with open("fruit_CNN_Model.json", "w") as json_file:
    json_file.write(model_json)

# Save the model weights
model.save_weights("fruit_CNN_Model.h5")
print("Saved model to disk")

# Optionally, you can also save the entire model (architecture + weights)
model.save("fruit_CNN_Model_complete.h5")

# Load the model later if needed
loaded_model = load_model("fruit_CNN_Model_complete.h5")